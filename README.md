...
Sequence UI is a standalone Svelte 5, Tailwind v4, and TypeScript design system extracted from the Sequence Toy app aesthetic. It is built for dense instrument panels: 12px base type, very tight spacing, sharp corners, flat surfaces, thin hairline borders, Lucide icons, gradient action buttons, and first-class light/dark theming.
