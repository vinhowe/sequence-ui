...
<div class={twMerge('inline-block', wrapperClass)} bind:this={wrapperEl}>
	<button
		...
		class="inline-flex h-control items-center gap-1 border border-border bg-panel px-1.5 text-foreground hover:bg-muted active:bg-border/50 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring type-button"
	>
