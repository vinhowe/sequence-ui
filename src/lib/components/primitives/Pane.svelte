		...
		<div class="-mb-px flex">
			{#each tabs as tab (tab.id)}
				...
				<button
					...
					class={twMerge(
						'flex items-center gap-1.5 border-r border-b border-border px-2 py-1 type-body transition-colors disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring',
						isActive
