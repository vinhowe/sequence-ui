<script lang="ts">
	...
	// The hover lift is the theme-scoped --lift-hover token (larger in dark, where
	// pastel gradients clip under brightness() and thin lifts read weaker anyway).
	const baseClasses =
		'inline-flex h-control items-center justify-center border px-1.5 hover:brightness-(--lift-hover) active:brightness-90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:opacity-50 disabled:saturate-50 disabled:hover:brightness-100 type-button';
